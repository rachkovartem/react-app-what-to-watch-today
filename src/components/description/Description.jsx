...
const Description = (props) => {
  ...
  const {poster, shortDescription, description, ratingKinopoisk, ratingImdb, type, year, genres, filmLength} = props;
          ...
          <div className="container">
            <div className="description__grid">
              <div className="description__poster-wrapper">
                <img className="description__poster" src={poster}/>
              </div>
              ...
              <div className="description__about">
                ...
                <div className="ratings ratings_position_initial">
                  <img className="rating-icon rating-icon_big" src={kinopoiskImg} alt="Кинопоиск"/>
                  <span className="rating rating_big">{ratingKinopoisk}</span>
                  <img className="rating-icon rating-icon_big rating-icon_margin_left" src={imdbImg} alt="IMDB"/>
